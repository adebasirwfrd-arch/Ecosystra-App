...
import { createEventSidebarSchema } from "../_schemas/event-sidebar-schema"
...
export function EventSidebar() {
  ...
  const eventSidebarSchema = useMemo(
    () => createEventSidebarSchema(allCategories),
    [allCategories]
  )

  const defaultCategory = allCategories[0] ?? "Miscellaneous"
  ...
  useEffect(() => {
    ...
    if (selectedEvent) {
      ...
      form.reset({
        ...
        category: extendedProps.category || defaultCategory,
