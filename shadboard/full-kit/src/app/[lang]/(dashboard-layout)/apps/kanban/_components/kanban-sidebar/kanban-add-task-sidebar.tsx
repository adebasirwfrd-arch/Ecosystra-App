...
import { createKanbanTaskSchema } from "../../_schemas/kanban-task-schema"
...
export function KanbanAddTaskSidebar() {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      label: labels[0]?.name ?? "",
      dueDate: new Date(),
      assigned: [] as KanbanTaskFormType["assigned"],
      comments: [] as KanbanTaskFormType["comments"],
      attachments: [] as KanbanTaskFormType["attachments"],
    }),
    [labels]
  )
