...
title: "Catalog"
name: "Docs"
importPath: "./src/pages/catalog/catalog.mdx"
iframeUrl: https://vibe.monday.com/iframe.html?id=catalog--docs&viewMode=docs
extractedWith: .sbdocs-wrapper
scrapedAt: 2026-04-17T16:30:55.640Z
---
...
Box
Box
Box component serves as a wrapper component.
Workspace
Board
Group
Breadcrumbs
...
NumberField
Allows users to input numeric values with controls for increment and decrement.
ProgressBar
...
Slider
Displays a slider bar with range selection
Spinner
Displays information related to an element over it.
Button
SplitButton
