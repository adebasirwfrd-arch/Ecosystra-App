...
- **`ecosystra-full-kit-alignment-checklist.md`** — milestone terukur untuk menyelaraskan backend `shadboard/full-kit` dengan pola dokumen ini (auth, API, CRM, email, GraphQL, RLS, TanStack Query).
